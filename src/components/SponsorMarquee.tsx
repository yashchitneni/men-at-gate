          ...
          {marqueeItems.map((sponsor, i) => (
            ...
            >
              <img
                src={sponsor.logo}
                alt={sponsor.name}
                className="h-8 md:h-12 w-auto max-w-[140px] md:max-w-[180px] object-contain brightness-0 invert opacity-50 hover:opacity-100 hover:filter-none transition-all duration-300"
